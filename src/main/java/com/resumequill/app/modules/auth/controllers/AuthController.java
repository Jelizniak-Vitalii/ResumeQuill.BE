...
import com.resumequill.app.modules.auth.dto.ForgotPasswordDto;
import com.resumequill.app.modules.auth.dto.GoogleLoginDto;
import com.resumequill.app.modules.auth.dto.ResetPasswordDto;
...
public class AuthController {
  ...
  public ResponseEntity<Void> googleLogin(
    ...
    String ip = authService.getClientIp(req);
    String userAgent = authService.getUserAgent(req);
    AuthResponseDto tokens = authService.loginWithGoogle(googleLoginDto.getIdToken(), ip, userAgent);
